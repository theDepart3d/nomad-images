        ...
        switch ($doing) {
            ...
            case 'stats':
                ...
                $chv_version = [
                    ...
                    'db'    => CHV\getSetting('nomad_version_installed')
                ];

                $system_values = [
                    'chv_version'	=> [
                        'label'		=> 'NomadImages-Free',
                        ...
                        . ' – <span class="icon icon-flow-branch"></span><a href="https://github.com/theDepart3d/nomad-images/releases/tag/0.0.8" target="_blank">0.0.8</a> fork <a class="btn btn-capsule outline red" data-action="check-for-updates"><span class="icon icon-bolt"></span>' . _s("check for updates") . '</a>',
                    ],
                    'php_version' => [
                ...
                $nomad_urls = [
                    'NomadImages'                => 'https://nomadimages.com',
                    _s('Community')                => 'https://nomadimages.com/community/',
                    _s('Support')                => 'https://nomadimages.com/support',
                    _s('Documentation')            => 'https://v3-docs.nomadimages.com',
                    _s('Changelog')                => 'https://nomadimages.com/releases',
                    _s('Bug tracking')            => 'https://nomadimages.com/bug-tracking',
                    'GitHub'                     => 'https://github.com/theDepart3d/nomad-images',
                ];
                $chevereto_links = [];
                foreach ($nomad_urls as $k => $v) {
