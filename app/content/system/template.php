...
<body>
  <div class="c20 center-box">
    <header id="header">
      <div id="logo"><img src="<?php echo G\absolute_to_url(CHV_APP_PATH_CONTENT_SYSTEM . 'nomadimages-logo.png'); ?>" alt=""></div>
    </header>
    <div id="content">
      <?php echo $html; ?>
    </div>
    <div id="powered">&copy; <a href="https://github.com/theDepart3d/nomad-images">Nomad Image hosting script</a></div>
  </div>
</body>
...
if (method_exists('CHV\Settings', 'getChevereto')) {
  echo '<script>var CHEVERETO = ' . json_encode(CHV\Settings::getNomad()) . '</script>';
}
?>
