...
// Folders definitions
define('CHV_FOLDER_IMAGES', !is_null(Settings::get('nomad_version_installed')) ? Settings::get('upload_image_path') : 'images');
...
if (access !== 'install' and Settings::get('nomad_version_installed')) {
