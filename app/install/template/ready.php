...
<p>On submit this process will install the NomadImages database tables and it will set some default settings that you can change later.</p>
...
<form method="post">
	...
	<div class="btn-container margin-bottom-0">
		<button class="btn btn-input default" type="submit">Install NomadImages</button>
	</div>
</form>