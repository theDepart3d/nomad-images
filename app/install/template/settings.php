...
<p>The database details are correct but NomadImages wasn't able to edit the <code>app/settings.php</code> file for you. This file is the one that stores this data.</p>
