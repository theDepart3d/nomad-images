...
try {
    ...
    if (!isset($_REQUEST['action'])) {
        Render\chevereto_die($e->getMessage(), "This installation can't use the automatic update functionality because this server is missing some crucial elements to allow NomadImages to perform the automatic update:", "Can't perform automatic update");
    } else {
