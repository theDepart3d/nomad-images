...
{
    $message = _s("This functionality is not part of NomadImages Free. %s to obtain this feature.", ['%s' => '<a data-action="upgrade"><span class="btn-icon icon-star4 color-yellow"></span> ' . _s('Upgrade') . '</a>']);
					...
					<ul class="tabbed-content-list table-li margin-top-20">
                        <li>
                            ...
                            <span class="display-table-cell vertical-align-middle" style="line-height: 1;">
                                <a class="github-button" href="https://github.com/theDepart3d/nomad-images/subscription" data-icon="octicon-eye" data-size="large" data-show-count="true" aria-label="Watch Cchevereto/chevereto-free on GitHub">Watch</a>
                                <a class="github-button" href="https://github.com/theDepart3d/nomad-images" data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star chevereto/chevereto-free on GitHub">Star</a>
                            </span>
                        </li>
						<?php
				...
				<?php
                    ...
                    if (get_dashboard() == 'settings') {
						...
						<?php if (get_settings()['key'] == 'website') { ?>
							...
							<div class-="phablet-c1">
								<div class="input-label">
									<label for="enable_powered_by"><?php _se('Powered by'); ?> NomadImages</label>
