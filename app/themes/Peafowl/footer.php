...
<div data-modal="form-upgrade" class="hidden">
	...
	<p>Upgrading to paid NomadImages enables access to all features and latest updates. This process is automated, you only need to paste your license key.</p>
    <p>All data will remain, and you can also count on support assistance.</p>
	<div class="btn-container"><button class="btn blue" data-action="submit" type="submit"><span class="btn-icon icon-next3"></span> Upgrade now</button> <a class="btn orange outline" href="javascript:void(0);" target="_blank"><span class="btn-icon icon-key3"></span> Purchase license</a></div>
</div>
<?php
} ?>
