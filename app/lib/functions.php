...
function getSystemNotices()
{
    ...
    if (getSetting('update_check_display_notification') && (version_compare(getSetting('update_check_notified_release'), getSetting('nomad_version_installed'), '>') && version_compare(getSetting('update_check_notified_release'), G_APP_VERSION, '>'))) {
    ...
    if (version_compare(G_APP_VERSION, getSetting('nomad_version_installed'), '>')) {
